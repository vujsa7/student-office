...
public class SubjectNotTeachedTable extends JTable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -8266595201966913376L;

	public SubjectNotTeachedTable() {
		setRowSelectionAllowed(true);
		setColumnSelectionAllowed(true);
		setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		setRowHeight(30);
		// Sama JTable komponenta je implementirana postujuci MVC arhitekturu.
		setModel(AbstractSubjectNotTeachedTable.getInstance());
