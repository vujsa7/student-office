...
public class AddProfesorToSubjectTable extends JTable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 9220436015936215853L;
	
	public AddProfesorToSubjectTable() {
		setRowSelectionAllowed(true);
		setColumnSelectionAllowed(true);
		setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		setRowHeight(30);
		// Sama JTable komponenta je implementirana postujuci MVC arhitekturu.
		setModel(AbstractAddProfesorToSubjectTable.getInstance());
