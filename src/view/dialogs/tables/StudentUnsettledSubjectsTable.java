...
public class StudentUnsettledSubjectsTable extends JTable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -6236325410695764948L;

	public StudentUnsettledSubjectsTable() {
		setRowSelectionAllowed(true);
		setColumnSelectionAllowed(true);
		setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		setRowHeight(30);
		// Sama JTable komponenta je implementirana postujuci MVC arhitekturu.
		setModel(AbstractStudentUnsettledSubjectsTable.getInstance());
