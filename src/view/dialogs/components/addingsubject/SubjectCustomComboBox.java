...
public class SubjectCustomComboBox extends JPanel{

	/**
	 * 
	 */
	private static final long serialVersionUID = 1413624360173675033L;
	
	private String field;
	private JComboBox<String> combo;
	
	public SubjectCustomComboBox(ArrayList<String> arrayList) {
		
		setLayout(new GridLayout(0,1));
		setMinimumSize(new Dimension(265,36));
		setMaximumSize(new Dimension(265,36));
		String[] array = arrayList.toArray(new String[arrayList.size()]);
		combo = new JComboBox<String>(array);	
		combo.setPreferredSize(new Dimension(265,36));
