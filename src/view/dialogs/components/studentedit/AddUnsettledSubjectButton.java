...
public class AddUnsettledSubjectButton extends JButton{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3734490747214365262L;
	private float alphaButton = 1f;
	public ImageIcon hoveredIcon;
	public ImageIcon icon;

	public AddUnsettledSubjectButton() {
		icon = getResizedIcon(new ImageIcon("assets"+ File.separator +"icons"+ File.separator +"add_button.png"));
		hoveredIcon = getResizedIcon(new ImageIcon("assets"+ File.separator +"icons"+ File.separator +"add_button_hovered.png"));
		setIcon(icon);
